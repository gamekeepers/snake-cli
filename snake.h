...
void input_handler()
{
    ...
    while (true)
    {
        ...
        */
        if (keymap.find(input) != keymap.end())
        {
            char new_direction = keymap[input];
            // ADDED THIS LOGIC: Prevent the snake from reversing on itself
            if (direction == 'r' && new_direction == 'l')
                continue;
            if (direction == 'l' && new_direction == 'r')
                continue;
            if (direction == 'u' && new_direction == 'd')
                continue;
            if (direction == 'd' && new_direction == 'u')
                continue;
